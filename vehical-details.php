...
$status=0;
$vhid=$_GET['vhid'];
$sql="INSERT INTO  tblcart(userEmail,VehicleId,FromDate,ToDate,message,Status) VALUES(:useremail,:vhid,:fromdate,:todate,:message,:status)";
...
if($lastInsertId)
{
echo "<script>alert('cart successfull.');</script>";
}
else
{
