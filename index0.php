	...
	<body class="landing">
		...
		<!-- Banner -->
			<section id="banner">
				...
				<p>Quick Search <br> Online carts <br> Pay Online <br> Hassle Free Bus cart<br>Brought To You By code-projects.org</p>
				<ul class="actions">
					<li>
				...
				<div class="container">
					...
					<div class="row 200%">
						...
						<section class="4u$ 12u$(small)">
							...
							<p>You can create your personal account and can see your cart history</p>
						</section>
					</div>
				</div>
			</section>
		...
		<!-- Two -->
			<section id="two" class="wrapper style2 align-center">
				<div class="container">
					...
					-->	</section>
						<p><b> Why BookMyBusTicket for Bus cart? </b>
<br>The leading player in online Bus carts in the country, We offer lowest fares, exclusive discounts and a seamless online cart experience. Desktop or mobile site is a delightfully customer friendly experience, and with just a few clicks you can complete your cart.</p>
<br> <br>
<p><b>cart Bus Ticket with BookMyBusTicket</b> <br>
