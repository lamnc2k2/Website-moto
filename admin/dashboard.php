									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light">
												<div class="stat-panel text-center">
<?php
$sql2 ="SELECT id from tblcart ";
$query2= $dbh -> prepare($sql2);
$query2->execute();
$results2=$query2->fetchAll(PDO::FETCH_OBJ);
$carts=$query2->rowCount();
?>

													<div class="stat-panel-number h1 "><?php echo htmlentities($carts);?></div>
													<div class="stat-panel-title text-uppercase">Total carts</div>
												</div>
											</div>
											<a href="manage-carts.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
